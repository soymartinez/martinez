...
export default function Nabvar() {
    ...
    return (
        <div className={clsx('fixed top-0 z-50 w-full px-4 border-b transition-all duration-500', {
            'bg-light/10 dark:bg-dark/50 ease-in-out backdrop-blur-sm border-stone/30 dark:border-[#363636]': scroll,
            'border-transparent': !scroll,
        })}>
